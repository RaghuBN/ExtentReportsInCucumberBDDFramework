...
public class YouTubeSearchStepDef {
	...
	public void open_chrome_browser_and_enter_url() throws Throwable 
	{
		...
		/* 
		System.setProperty("webdriver.chrome.driver", "C:\\Users\\mampi\\eclipse-workspace\\SeleniumCucumberBDDFramework\\resources\\chromedriver.exe");
	...
	{
		driver.findElement(By.id("search")).sendKeys("selenium by SDET");		
		Thread.sleep(1000);	 	    
	}
